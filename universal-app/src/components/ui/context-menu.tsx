 ...
 * Supports icons, keyboard shortcuts, separators, disabled items, and nested submenus.
 * 
 * @example
 * ```tsx
 * <ContextMenu>
...
>(({ className, inset, children, ...props }, ref) => (
  <ContextMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-[var(--primary-soft)] focus:text-[var(--text-primary)]",
      "data-[state=open]:bg-[var(--primary-soft)] data-[state=open]:text-[var(--text-primary)]",
      inset && "pl-8",
      className
    )}
    {...props}
  ...
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      ...
      variant === 'destructive' && [
        ...
        "dark:focus:bg-red-950 dark:focus:text-red-300",
      ],
      inset && "pl-8",
      className
    )}
...
/**
 * Display keyboard shortcut hints in menu items
 */
...
/**
 * Wrapper for consistent icon styling in menu items
 */
...
const ContextMenuIcon = ({ children, className }: ContextMenuIconProps) => {
  return (
    <span className={cn("mr-2 h-4 w-4 flex-shrink-0", className)}>
      {children}
    </span>
  )
}
