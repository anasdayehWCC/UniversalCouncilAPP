...
class Organisation(BaseTableMixin, table=True):
    ...
    domains: list["ServiceDomain"] = Relationship(back_populates="organisation")
    users: list["UserOrgRole"] = Relationship(back_populates="organisation")
...
class ServiceDomain(BaseTableMixin, table=True):
    ...
    users: list["UserOrgRole"] = Relationship(back_populates="service_domain")
...
class Role(BaseTableMixin, table=True):
    ...
    users: list["UserOrgRole"] = Relationship(back_populates="role")
...
class UserOrgRole(BaseTableMixin, table=True):
    ...
    user: "User" = Relationship(back_populates="org_roles")
    organisation: Organisation = Relationship(back_populates="users")
    service_domain: ServiceDomain | None = Relationship(back_populates="users")
...
class User(BaseTableMixin, table=True):
    ...
    org_roles: list["UserOrgRole"] = Relationship(back_populates="user")
