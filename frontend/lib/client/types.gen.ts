...
export type GetSignedRecordingRangeData = {
  body?: never
  path: {
    transcription_id: string
    recording_id: string
...
export type GetSignedRecordingRangeResponses = {
  /**
   * Successful Response
   */
...
export type GetSignedRecordingRangeResponse =
  GetSignedRecordingRangeResponses[keyof GetSignedRecordingRangeResponses]

export type PostEvidenceClickData = {
...
export type PostEvidenceClickResponses = {
  /**
   * Successful Response
   */
  204: void
...
export type PostEvidenceClickResponse =
  PostEvidenceClickResponses[keyof PostEvidenceClickResponses]
