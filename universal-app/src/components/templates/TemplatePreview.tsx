    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="bg-slate-50 rounded-lg p-3 text-center">
          ...
          <div className="text-lg font-bold text-slate-900">{template.sections.length}</div>
        ...
        <div className="bg-slate-50 rounded-lg p-3 text-center">
          ...
          <div className="text-lg font-bold text-slate-900">{requiredCount}</div>
        ...
        <div className="bg-slate-50 rounded-lg p-3 text-center">
          ...
          <div className="text-lg font-bold text-slate-900">{template.estimatedDuration || '–'}</div>
      ...
      {showFullDetails && template.longDescription && (
        <div className="mb-4 p-4 bg-slate-50 rounded-lg">
          <h3 className="text-sm font-semibold text-slate-700 mb-2">About this template</h3>
          <p className="text-sm text-slate-600">{template.longDescription}</p>
        </div>
      )}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {section.helpText && !showFullDetails && (
                    <p className="text-xs text-slate-400 mt-0.5">{section.helpText}</p>
                  )}
                </div>
