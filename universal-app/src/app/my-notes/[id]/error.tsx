...
export default function NoteError({
  ...
  React.useEffect(() => {
    console.error('[my-notes/[id]/error.tsx] Error caught:', error);
  }, [error]);
      ...
      <Card className="max-w-lg w-full shadow-lg border-destructive/20">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-xl">
            {isNotFound ? 'Note Not Found' : 'Failed to Load Note'}
          </CardTitle>
          <CardDescription className="text-base">
            {isNotFound
              ? 'This note may have been deleted or you may not have access.'
              : 'This note couldn\u2019t be loaded. Please try again.'}
          </CardDescription>
          {error.digest && (
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Link href="/my-notes" className="flex-1">
